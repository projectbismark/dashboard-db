...
create domain osname_t as varchar(20) DEFAULT NULL::varchar;
create domain version_t as varchar(20) DEFAULT NULL::varchar;
create domain device_type_t as varchar(20) DEFAULT NULL::varchar;
