...
class ArpLogs(models.Model):
    ...
    timestamp = models.BigIntegerField(unique=True, null=True, blank=True)
    macid = models.CharField(max_length=60, blank=True)
    ip = models.BigIntegerField(unique=True, null=True, blank=True)
    class Meta:
        db_table = u'ARP_LOGS'
...
class DhcpLogs(models.Model):
    ...
    timestamp = models.BigIntegerField(unique=True, null=True, db_column='TIMESTAMP', blank=True) # Field name made lowercase.
    action = models.CharField(max_length=60, db_column='ACTION', blank=True) # Field name made lowercase.
    ip = models.BigIntegerField(unique=True, null=True, db_column='IP', blank=True) # Field name made lowercase.
...
class Flows(models.Model):
    ...
    flowid = models.BigIntegerField(unique=True)
    ...
    uppkts = models.BigIntegerField()
    dwpkts = models.BigIntegerField()
    upbytes = models.BigIntegerField()
    dwbytes = models.BigIntegerField()
...
class Flows17Jul26Oct2010(models.Model):
    ...
    flowid = models.BigIntegerField(unique=True)
    deviceid = models.CharField(max_length=45)
    srcip = models.BigIntegerField()
    dstip = models.BigIntegerField()
    proto = models.IntegerField()
    srcport = models.IntegerField()
    dstport = models.IntegerField()
...
class Flows26Oct7Dec2010(models.Model):
    ...
    upbytes = models.IntegerField()
    dwbytes = models.IntegerField()
    tsstart = models.BigIntegerField(unique=True)
    tsend = models.BigIntegerField()
    app = models.CharField(max_length=60)
    class Meta:
...
class FlowsSamples26Oct7Dec2010(models.Model):
    ...
    upbytes = models.IntegerField()
    dwbytes = models.IntegerField()
    tsstart = models.BigIntegerField()
    tsend = models.BigIntegerField(unique=True)
    class Meta:
...
class Measurements(models.Model):
    ...
    srcip = models.BigIntegerField(null=True, blank=True)
    dstip = models.BigIntegerField(null=True, blank=True)
    timestamp = models.BigIntegerField(unique=True, null=True, blank=True)
...
class Traceroutes(models.Model):
    ...
    hops = models.BigIntegerField(null=True, blank=True)
    class Meta:
...
class ViewMeasurements(models.Model):
    ...
    isp = models.CharField(max_length=90, blank=True)
    sla = models.CharField(max_length=150, blank=True)
    sla_start = models.BigIntegerField(null=True, blank=True)
    sla_end = models.BigIntegerField(null=True, blank=True)
...
class WifiAssoc(models.Model):
    ...
    firstseen = models.BigIntegerField(null=True, db_column='FIRSTSEEN', blank=True) # Field name made lowercase.
    lastseen = models.BigIntegerField(null=True, db_column='LASTSEEN', blank=True) # Field name made lowercase.
